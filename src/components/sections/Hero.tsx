...
export function Hero() {
  ...
  return (
    <section className="relative mx-auto w-full pt-40 px-6 text-center md:px-8 min-h-[calc(100vh-40px)] overflow-hidden rounded-b-xl bg-black">
      {/* Starfield Background */}
      <StarfieldCanvas className="z-0" />
