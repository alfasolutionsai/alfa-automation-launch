      ...
      <div className="container relative mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="mb-6 text-4xl font-bold tracking-tight text-foreground md:text-6xl lg:text-7xl">​Utilisez l'intelligence artificielle pour faire grandir votre entreprisefaire grandir votre entreprise            <span className="text-primary">AI Automation</span> That Actually Works
            </h1>
