...
export function Solutions() {
  const features = [
    ...
    },
    {
      ...
      blurb:
        "Se connecte parfaitement à vos outils actuels sans mal de tête technique ni formation compliquée pour votre équipe. Aucune interruption, tout roule dès le jour 1.",
      meta: "Intégration",
      icon: Cloud,
    ...
    },
    {
      ...
      blurb:
        "Des tableaux de bord et CRM faits pour vous montrer exactement ce dont vous avez besoin et suivre vos clients comme vous le souhaitez. Une vision claire, des données utiles et un contrôle total.",
      meta: "Tableaux",
      icon: Settings,
    ...
    },
    {
      ...
      blurb:
        "Conçu pour vous aider à augmenter vos revenus, pas seulement à économiser du temps. Plus de volume, plus de clients et plus de profit sans agrandir votre équipe.",
      meta: "Croissance",
      icon: Rocket,
    ...
    },
    {
      ...
      blurb:
        "Construit exactement pour vos opérations, pas de logiciel générique imposé. Tout fonctionne comme vos processus actuels. Zéro friction, zéro adaptation forcée.",
      meta: "Sur mesure",
      icon: Wrench,
          ...
          <div className="flex flex-col md:flex-row h-full">
            ...
            <div className="flex-1 p-8 md:p-12 relative z-10 flex flex-col justify-center">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-lg">
                Alfa crée des systèmes d'IA adaptés à vos processus d'affaires. Pas des outils génériques que vous devez
                tordre pour faire fonctionner. On construit des automatisations intelligentes conçues autour de votre
