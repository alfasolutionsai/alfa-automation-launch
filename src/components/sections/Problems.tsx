...
export function Problems() {
  return <section id="problems" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-4">​Vous perdez de l'argent à vue d'oeil                </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Chaque tâche manuelle ou opportunité ratée vous coût. Here's what we see every day:
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          {problems.map((problem, index) => <Card key={index} className="p-6 hover:border-accent transition-all duration-300 hover:shadow-lg hover:glow-accent group">
